...
COMPLEMENTS = {
    'living/sofas-couches': ['living/coffee-tables', 'living/lounge-chairs', 'living/floor-lamps', 'decor-outdoor/wall-art'],
    'living/coffee-tables': ['living/sofas-couches', 'living/lounge-chairs', 'decor-outdoor/vases', 'living/table-lamps'],
    'living/lounge-chairs': ['living/floor-lamps', 'living/coffee-tables', 'decor-outdoor/vases', 'living/sofas-couches'],
    'bedroom-dining/beds': ['bedroom-dining/nightstands', 'bedroom-dining/wardrobes', 'living/table-lamps', 'decor-outdoor/wall-art'],
    'bedroom-dining/nightstands': ['bedroom-dining/beds', 'living/table-lamps', 'decor-outdoor/vases', 'bedroom-dining/wardrobes'],
    'bedroom-dining/wardrobes': ['bedroom-dining/beds', 'bedroom-dining/nightstands', 'decor-outdoor/mirrors', 'living/floor-lamps'],
    'bedroom-dining/dining-tables': ['bedroom-dining/dining-chairs', 'living/pendant-lights', 'decor-outdoor/vases', 'decor-outdoor/wall-art'],
    'bedroom-dining/dining-chairs': ['bedroom-dining/dining-tables', 'living/pendant-lights', 'decor-outdoor/vases'],
    'living/pendant-lights': ['bedroom-dining/dining-tables', 'living/sofas-couches', 'decor-outdoor/wall-art'],
    'living/floor-lamps': ['living/lounge-chairs', 'living/sofas-couches', 'decor-outdoor/wall-art'],
    'living/table-lamps': ['bedroom-dining/nightstands', 'living/coffee-tables', 'decor-outdoor/vases'],
    'decor-outdoor/vases': ['decor-outdoor/wall-art', 'decor-outdoor/mirrors', 'living/coffee-tables'],
    'decor-outdoor/mirrors': ['bedroom-dining/wardrobes', 'decor-outdoor/wall-art', 'decor-outdoor/vases'],
    'decor-outdoor/wall-art': ['decor-outdoor/vases', 'decor-outdoor/mirrors', 'living/sofas-couches', 'bedroom-dining/beds'],
    'decor-outdoor/garden-furniture': ['decor-outdoor/outdoor-lighting', 'decor-outdoor/vases'],
    'decor-outdoor/outdoor-lighting': ['decor-outdoor/garden-furniture'],
    'cadeaubonnen': ['decor-outdoor/vases', 'decor-outdoor/wall-art', 'living/sofas-couches', 'bedroom-dining/beds'],
}
